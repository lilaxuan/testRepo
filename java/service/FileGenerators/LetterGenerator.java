...
/**
 * LetterGenerator is a class that implements the EmailLetterGeneratorsI
 ...
 */
public class LetterGenerator extends EmailLetterGeneratorAbstract implements EmailLetterGeneratorsI {
     ...
     * Constructor
     *
     * @param templatePath - the given path of the letter template, expected as a string
     ...
     */
    public LetterGenerator(String templatePath, String csvFilePath) throws IOException {
        super(templatePath, csvFilePath);
    }

    /**
     * generateFileName is a method to generate the file names of the letters
     * based on the user's first name and last name
     *
     * @param outputDir - the output dir of the generated letters where they can be saved, expected as a string
     ...
     * @return the file name of the generated letters
     */
    @Override
    public String generateFileName(String outputDir, List<String> eachRow, Map<String, Integer> headerInfoMap) {
        ...
        String fileName = outputDir + eachRow.get(headerInfoMap.get(FIRST_NAME)) + "_" + eachRow.get(headerInfoMap.get(LAST_NAME)) + "_letter" + ".txt";
        return fileName;
    }
